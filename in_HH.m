...
tmax=250;    %duration of experiment (ms)
...
vstart= vhold;  %(mV), so that no extra current is put in at the beginning
...
ip=10;        %current applied (muA) - constantly or max of current pulse
    ...
    % amount of current is being outputted (t1p and t2p do not matter)
%
